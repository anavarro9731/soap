...
namespace Soap.Api.Sample.Tests.Messages.Commands.C106
{
    ...
    public class TestC106v1WhenSendingMessageLessThan256KUsingBus : Test
    {
        private readonly Guid id = Guid.NewGuid();

        public TestC106v1WhenSendingMessageLessThan256KUsingBus(ITestOutputHelper outputHelper)
            : base(outputHelper)
        {
            ...
            TestMessage(c106V1LargeCommand, Identities.JohnDoeAllPermissions, 0, clientOptions: new SoapClient.BusOptions()).Wait();
        }
