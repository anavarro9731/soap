...
namespace Soap.Api.Sample.Tests.Messages.Commands.C106
{
    ...
    //when sending message less than 256KB
    public class TestC106v1WhenSendingMessageBlobbedOnServer : Test
    {
        private readonly Guid id = Guid.NewGuid();

        public TestC106v1WhenSendingMessageBlobbedOnServer(ITestOutputHelper outputHelper)
            : base(outputHelper)
        {
