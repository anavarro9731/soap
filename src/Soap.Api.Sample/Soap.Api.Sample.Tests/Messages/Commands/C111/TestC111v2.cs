namespace Soap.Api.Sample.Tests.Messages
{
    ...
    public class TestC111v2 : Test
    {
        ...
        public TestC111v2(ITestOutputHelper outputHelper)
            : base(outputHelper)
        {
            ...
            TestMessage(new C111v2_GetRecentTestData(), Identities.JohnDoeAllPermissions).Wait();
        }
