...
namespace Soap.Api.Sample.Logic.Processes
{
    ...
    /// </summary>
    public class P201_C104__TestUnitOfWork : Process, IBeginProcess<C104v1_TestUnitOfWork>
    {
            ...
            async message =>
                ...
                async Task PublishE150()
                {
                    ...
                    await Bus.Publish(
                        new E100v1_Pong
                        {
                            E000_PongedBy = nameof(P201_C104__TestUnitOfWork)
                        });
                }
                ...
                async Task SendC100()
                {
                    await Bus.Send(
                        new C100v1_Ping
                        {
                            C000_PingedBy = nameof(P201_C104__TestUnitOfWork)
                        });
                }
                };
    }
