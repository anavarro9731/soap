...
Soap centers on services and a Service in the SOAP context is a collection of code which has the following purposes: 
...
Within each service there is a clear distinction between "Domain" and "Infrastructure".
...
As highlighted in the above goals, we try to meet all the Infrastructure requirements with the framework code 
