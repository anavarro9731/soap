    ...
    public class ObjectExtensionsTests
    {
        public class WhenTestingWithFQNames
        {
            ...
            public void ItShouldReturnTheRightValues()
            {
                ...
                Assert.Equal(
                    ...
                    typeof(KeyValuePair<int, string>).AsTypeNameString(true));
                Assert.Equal("System.Tuple<int, string>", typeof(Tuple<int, string>).AsTypeNameString(true));
                Assert.Equal(
                    "System.Tuple<KeyValuePair<object, long>, string>",
                    typeof(Tuple<KeyValuePair<object, long>, string>).AsTypeNameString(true));
                Assert.Equal(
                    "System.Collections.Generic.List<Tuple<int, string>>",
                    typeof(List<Tuple<int, string>>).AsTypeNameString(true));
                ...
                Assert.Equal(
                    "Soap.Tests.ObjectExtensionsTests+TestNestedGeneric<string>",
                    typeof(TestNestedGeneric<string>).AsTypeNameString(true));
            }
        }
        ...
        public class WhenTestingWithShortNames
        {
            ...
            public void ItShouldReturnTheRightValues()
            {
                ...
                Assert.Equal(
                    "Tuple<KeyValuePair<object, long>, string>",
                    typeof(Tuple<KeyValuePair<object, long>, string>).AsTypeNameString());
                ...
                Assert.Equal(
                    "ObjectExtensionsTests+TestNestedGeneric<string>",
                    typeof(TestNestedGeneric<string>).AsTypeNameString());
            }
        }
