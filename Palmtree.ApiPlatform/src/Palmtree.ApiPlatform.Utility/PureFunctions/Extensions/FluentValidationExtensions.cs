namespace Palmtree.ApiPlatform.Utility.PureFunctions.Extensions
{
    using System;
    ...
    public class MaxLengthValidator : PropertyValidator
    {
        public MaxLengthValidator(int maxLength)
            : base("{PropertyName} must contain less than " + maxLength + " characters")
        {
            MaxLength = maxLength;
        }
    ...
    public class InValidator<T> : PropertyValidator
    {
            ...
            : base("Property {PropertyName} not in the specified enumerable.")
        {
            ...
            if (enumerable == null) throw new ArgumentNullException(nameof(enumerable), "Enumerable should not be null.");
        }
