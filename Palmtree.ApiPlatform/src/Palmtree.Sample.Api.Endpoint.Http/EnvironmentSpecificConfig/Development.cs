    ...
    public class Development : IHttpEnvironmentSpecificConfiguration
    {
        public IApplicationConfig Variables => ApplicationConfiguration.Create(
            ...
            FileStorageSettings.Create(
                "DefaultEndpointsProtocol=https;AccountName=anavarro9731serviceapi;AccountKey=vZ3Rp3+wUrbdNQxTDaf+Za4XoiUtXeQ5GxWQU+WphJ9SdZWohA9ceCnbIlyI+y6Fehq8PZc8340fuqZoV+2jDw==;BlobEndpoint=https://anavarro9731Palmtree.ApiPlatform.blob.core.windows.net/;",
                string.Empty),
